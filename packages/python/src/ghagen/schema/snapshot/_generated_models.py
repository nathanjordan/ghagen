...
#   timestamp: 2026-04-07T03:53:09+00:00
...
class BranchProtectionRule1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    types: list[Type] | None = Field(
...
class DiscussionComment(BaseModel):
    ...
    types: list[Type8] | None = Field(
        ['created', 'edited', 'deleted'],
        description='Selects the types of activity that will trigger a workflow run. Most GitHub events are triggered by more than one type of activity. For example, the event for the release resource is triggered when a release is published, unpublished, created, edited, deleted, or prereleased. The types keyword enables you to narrow down activity that causes the workflow to run. When only one activity type triggers a webhook event, the types keyword is unnecessary.\nYou can use an array of event types. For more information about each event and their activity types, see https://help.github.com/en/articles/events-that-trigger-workflows#webhook-events.',
    )


class DiscussionComment1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    types: list[Type8] | None = Field(
...
class MergeGroup(BaseModel):
    ...
    types: list[Type16] | None = Field(
        ['checks_requested'],
        description='Selects the types of activity that will trigger a workflow run. Most GitHub events are triggered by more than one type of activity. For example, the event for the release resource is triggered when a release is published, unpublished, created, edited, deleted, or prereleased. The types keyword enables you to narrow down activity that causes the workflow to run. When only one activity type triggers a webhook event, the types keyword is unnecessary.\nYou can use an array of event types. For more information about each event and their activity types, see https://help.github.com/en/articles/events-that-trigger-workflows#webhook-events.',
    )


class MergeGroup1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    types: list[Type16] | None = Field(
...
class PullRequestReview(BaseModel):
    ...
    types: list[Type27] | None = Field(
        ['submitted', 'edited', 'dismissed'],
        description='Selects the types of activity that will trigger a workflow run. Most GitHub events are triggered by more than one type of activity. For example, the event for the release resource is triggered when a release is published, unpublished, created, edited, deleted, or prereleased. The types keyword enables you to narrow down activity that causes the workflow to run. When only one activity type triggers a webhook event, the types keyword is unnecessary.\nYou can use an array of event types. For more information about each event and their activity types, see https://help.github.com/en/articles/events-that-trigger-workflows#webhook-events.',
    )


class PullRequestReview1(BaseModel):
    model_config = ConfigDict(
        extra='allow',
    )
    types: list[Type27] | None = Field(
...
class Inputs(BaseModel):
    ...
    default: bool | float | str | None = Field(
        None,
...
class WorkflowCall(BaseModel):
    ...
    outputs: dict[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$'), Outputs] | None = Field(
        None,
        description='When using the workflow_call keyword, you can optionally specify inputs that are passed to the called workflow from the caller workflow.',
    )
    secrets: dict[constr(pattern=r'^[_a-zA-Z][a-zA-Z0-9_-]*$'), Secrets] | None = Field(
        None,
...
class WorkflowRun(BaseModel):
    ...
    types: list[Type37] | None = Field(
        ['requested', 'completed'],
        description='Selects the types of activity that will trigger a workflow run. Most GitHub events are triggered by more than one type of activity. For example, the event for the release resource is triggered when a release is published, unpublished, created, edited, deleted, or prereleased. The types keyword enables you to narrow down activity that causes the workflow to run. When only one activity type triggers a webhook event, the types keyword is unnecessary.\nYou can use an array of event types. For more information about each event and their activity types, see https://help.github.com/en/articles/events-that-trigger-workflows#webhook-events.',
    )
    workflows: list[str] | None = Field(None, min_length=1)
...
class Configuration(
    RootModel[
        Union[str, float, bool, dict[str, "Configuration"], list["Configuration"]]
    ]
):
...
class EventObject(RootModel[dict[str, Any] | None]):
...
class Matrix(
    RootModel[
        dict[
            ...
            ExpressionSyntax | list[dict[str, Configuration]],
        ]
        | ExpressionSyntax
    ]
):
...
class Shell(RootModel[str | Shell1]):
    root: str | Shell1 = Field(
        ...,
...
class Snapshot1(BaseModel):
    ...
    image_name: str = Field(..., alias='image-name')
    version: constr(pattern=r'^\d+(\.\d+|\*)?$') | None = None


class Snapshot(RootModel[str | Snapshot1]):
    root: str | Snapshot1 = Field(
        ...,
...
class Types(RootModel[list[Any] | str]):
    root: list[Any] | str = Field(
        ...,
        description='Selects the types of activity that will trigger a workflow run. Most GitHub events are triggered by more than one type of activity. For example, the event for the release resource is triggered when a release is published, unpublished, created, edited, deleted, or prereleased. The types keyword enables you to narrow down activity that causes the workflow to run. When only one activity type triggers a webhook event, the types keyword is unnecessary.\nYou can use an array of event types. For more information about each event and their activity types, see https://help.github.com/en/articles/events-that-trigger-workflows#webhook-events.',
    )
...
class Run(BaseModel):
    ...
    working_directory: WorkingDirectory | None = Field(None, alias='working-directory')
...
class Env(RootModel[dict[str, str | float | bool] | StringContainingExpressionSyntax]):
    root: dict[str, str | float | bool] | StringContainingExpressionSyntax = Field(
        ...,
...
class Environment(BaseModel):
    ...
    deployment: bool | ExpressionSyntax | None = Field(
        True,
    ...
    url: str | None = Field(None, description='A deployment URL')


class JobNeeds(RootModel[list[Name] | Name]):
    root: list[Name] | Name = Field(
        ...,
...
class PermissionsEvent(BaseModel):
    ...
    artifact_metadata: PermissionsLevel | None = Field(None, alias='artifact-metadata')
    ...
    id_token: PermissionsLevel | None = Field(None, alias='id-token')
    issues: PermissionsLevel | None = None
    models: Models | None = None
    packages: PermissionsLevel | None = None
    pages: PermissionsLevel | None = None
    pull_requests: PermissionsLevel | None = Field(None, alias='pull-requests')
    repository_projects: PermissionsLevel | None = Field(
        None, alias='repository-projects'
    )
    security_events: PermissionsLevel | None = Field(None, alias='security-events')
...
class Step1(BaseModel):
    ...
    shell: Shell | None = None
    timeout_minutes: float | ExpressionSyntax | None = Field(
        None,
...
class Step(RootModel[Step1 | Step2]):
    root: Step1 | Step2


class PullRequest(BaseModel):
    branches: Branch | None = None
    branches_ignore: Branch | None = Field(None, alias='branches-ignore')
    paths: Path | None = None
    paths_ignore: Path | None = Field(None, alias='paths-ignore')
    tags: Branch | None = None
    tags_ignore: Branch | None = Field(None, alias='tags-ignore')
    types: list[Type26] | None = Field(
...
class On(BaseModel):
    ...
    branch_protection_rule: BranchProtectionRule | BranchProtectionRule1 | None = Field(
        None,
    ...
    check_run: CheckRun | CheckRun1 | None = Field(
        None,
    ...
    check_suite: CheckSuite | CheckSuite1 | None = Field(
        None,
    ...
    deployment: EventObject | None = Field(
        None,
    ...
    deployment_status: EventObject | None = Field(
        None,
    ...
    discussion: Discussion | Discussion1 | None = Field(
        None,
    ...
    discussion_comment: DiscussionComment | DiscussionComment1 | None = Field(
        None,
    ...
    issues: Issues | Issues1 | None = Field(
        None,
    ...
    merge_group: MergeGroup | MergeGroup1 | None = Field(
        None,
    ...
    milestone: Milestone | Milestone1 | None = Field(
        None,
    ...
    page_build: EventObject | None = Field(
        None,
    ...
    project: Project | Project1 | None = Field(
        None,
    ...
    project_card: ProjectCard | ProjectCard1 | None = Field(
        None,
    ...
    project_column: ProjectColumn | ProjectColumn1 | None = Field(
        None,
    ...
    pull_request_review: PullRequestReview | PullRequestReview1 | None = Field(
        None,
    ...
    pull_request_review_comment: (
        PullRequestReviewComment | PullRequestReviewComment1 | None
    ) = Field(
        None,
    ...
    pull_request_target: PullRequestTarget | None = Field(
        None,
    ...
    registry_package: RegistryPackage | RegistryPackage1 | None = Field(
        None,
    ...
    release: Release | Release1 | None = Field(
        None,
    ...
    repository_dispatch: EventObject | None = Field(
        None,
    ...
    workflow_call: WorkflowCall | None = Field(
        None, description='Allows workflows to be reused by other workflows.'
    )
    workflow_dispatch: WorkflowDispatch | None = Field(
        None,
    ...
    workflow_run: WorkflowRun | WorkflowRun1 | None = Field(
        None,
...
class Container(BaseModel):
    ...
    ports: list[float | str] | None = Field(
        None,
...
class Permissions(RootModel[Permissions1 | PermissionsEvent]):
    root: Permissions1 | PermissionsEvent = Field(
        ...,
...
class ReusableWorkflowCallJob(BaseModel):
    ...
    secrets: Env | Secrets1 | None = Field(
        None,
