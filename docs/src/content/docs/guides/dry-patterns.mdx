...
```typescript
import { checkout, setupNode, setupPython } from "ghagen";
...
import type { JobModel } from "ghagen";
...
// .github/common.ts
import { step, checkout, setupPython } from "ghagen";
import type { StepModel } from "ghagen";
