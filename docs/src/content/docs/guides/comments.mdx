...
import {
  commentBlockYaml,
  commentEolYaml,
  commentFieldBlockYaml,
  commentFieldEolYaml,
  commentFullYaml,
  headerVerbatimYaml,
} from "../../../snippets/emitted.ts";
...
<Code code={commentBlockYaml} lang="yaml" />
...
<Code code={commentEolYaml} lang="yaml" />
...
```typescript
import { job, on, pushTrigger, step, withComment, workflow } from "@ghagen/ghagen";
...
<Code code={commentFieldBlockYaml} lang="yaml" />
...
```typescript
import { job, on, pushTrigger, step, withEolComment, workflow } from "@ghagen/ghagen";
...
<Code code={commentFieldEolYaml} lang="yaml" />
...
```typescript
name: withEolComment(withComment("CI", "Block comment"), "EOL comment");
```
...
```typescript
import { job, on, pushTrigger, step, withComment, withEolComment, workflow } from "@ghagen/ghagen";
...
<Code code={commentFullYaml} lang="yaml" />
...
<Code code={headerVerbatimYaml} lang="yaml" />
