...
<Tabs syncKey="lang">
  ...
  <TabItem label="TypeScript">
    ...
    This runs your TypeScript definitions and writes the corresponding YAML to the paths specified in your `toYamlFile` calls.
...
<Tabs syncKey="lang">
  ...
  <TabItem label="TypeScript">
    Run the workflow script and check for uncommitted changes:
    ...
    Add this as a CI step to catch drift between your TypeScript definitions and the committed YAML.
...
- [Linting](./python/linting/) -- Catch common mistakes in your definitions _(Python)_
- [CLI Reference](./python/cli/) -- Full command documentation _(Python)_
