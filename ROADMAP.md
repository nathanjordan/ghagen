...
- **GitHub Action** — Composite action (`action.yml`) wrapping `ghagen check-synced` for users to add workflow freshness checking to their CI (`uses: nathanjordan/ghagen@v0`)
